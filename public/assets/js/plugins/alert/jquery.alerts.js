...
(function($) {
	...
	$.alerts = {
		...
		customConfirm: function(message, title, okButton, cancelButton, callback) {
			if( title == null ) title = 'Custom Confirm';
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input class="btn btn-primary btn-xs" type="button" value="' + $.alerts.okButton + '" id="popup_ok" /></div><div class="icon_alert"><i class="fa fa-info-circle"></i></div>');
				...
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" class="btn btn-default  btn-xs"/> <input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="btn btn-primary  btn-xs"/></div><div class="icon_alert"><i class="fa fa-question-circle"></i></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
				...
				case 'prompt':
					$("#popup_message").append('<br /><input type="text" id="popup_prompt" class="form-control input-sm"/><div class="icon_alert"><i class="fa fa-info-circle"></i></div>').after('<div id="popup_panel"><input class="btn btn-default  btn-xs" type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /> <input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="btn btn-primary  btn-xs"/></div>');
				...
				case "customPopup":
					$("#popup_body").after('<div id="popup_panel"><input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" class="btn btn-default  btn-xs"/> <input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="btn btn-primary  btn-xs"/></div><div class="close button-close"><i class="fa fa-times-circle"><div>');
					//validate form
