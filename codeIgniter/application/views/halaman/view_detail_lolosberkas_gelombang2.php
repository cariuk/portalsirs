...
<head>
    ...
    <title>RSIA Ananda - Pengumuman Lolos Berkas Gelombang 2</title>
...
<div class="main-banner five">
    <div class="container">
        <h2><span>Pengumuman Lolos Berkas Gelombang 2</span></h2>
    </div>
</div>
<!-- Main Banner Ends -->
<!-- Breadcrumb Starts -->
<div class="breadcrumb">
    <div class="container">
        <ul class="list-unstyled list-inline">
            ...
            <li class="active">Pengumuman Lolos Berkas Gelombang 2</li>
        </ul>
    </div>
</div>
<!-- Breadcrumb Ends -->
        ...
        <div class="col-md-9 col-xs-12">
            ...
            <div class="news-post-single">
                ...
                <article class="news-post">
                    ...
                    <div class="inner">
                        <h4>Pengumuman Lolos Berkas Penerimaan Karyawan Gelombang 2</h4>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-calendar-o"></i> Sabtu, 2 Juli 2016</li>
                                        <li><i class="fa fa-clock-o"></i> 08:00 WITA</li>
